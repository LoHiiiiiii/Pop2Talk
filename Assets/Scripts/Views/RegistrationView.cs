...
public class RegistrationView : View {
	...
	[Space]
	[SerializeField] string serverUrl = "https://schools.pop2talk.com/api/game/";
	[SerializeField] string userCheckPath = "checkUsername";
	[SerializeField] string registerPath = "register";
	[SerializeField] string requestTosUrl = "https://schools.pop2talk.com/readServiceConditions";

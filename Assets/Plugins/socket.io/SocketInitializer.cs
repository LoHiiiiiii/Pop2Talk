    ...
    public class SocketInitializer : MonoBehaviour {
        ...
        public string WebSocketUrl {
            get {
                ...
                else if (Socket.Url.Scheme == "https")
                {
                    var builder = new StringBuilder(BaseUrl.Replace("https://", "wss://"));
                    //hard-coded, ugly
                    builder.Append("/popws/");
        ...
        IEnumerator InitCore(UniRx.IObserver<Socket> observer, CancellationToken cancelToken) {
            ...
            Debug.Log("Wait Until WebSocketTrigger is connected");
            yield return new WaitUntil(() => webSocketTrigger.IsConnected);
            Debug.Log("WebSocketTrigger is connected");
